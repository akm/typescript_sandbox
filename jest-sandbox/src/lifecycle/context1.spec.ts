...
describe("Scoped / Nested block #3", () => {
  beforeAll(() => logger.info(`3 - beforeAll`));
  afterAll(() => logger.info(`3 - afterAll`));
  beforeEach(() => logger.info(`3 - beforeEach`));
  afterEach(() => logger.info(`3 - afterEach`));
  test("", () => logger.info(`3 - test`));
});
